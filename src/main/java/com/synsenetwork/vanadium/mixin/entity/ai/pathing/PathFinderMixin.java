...
public class PathFinderMixin {
    ...
    private synchronized @Nullable Path syncFindPathToAny(PathNavigationRegion world, Mob mob, Set<BlockPos> positions, float followRange, int distance, float rangeMultiplier, Operation<Path> original) {
